...
Partial Public Class _Default
	...
	Private Shared Function CalcPercentageComplete(ByVal series As Series, ByVal argument As Object, ByVal functionArguments() As String, ByVal values() As DataSourceValues) As SeriesPoint()
